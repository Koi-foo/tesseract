...
# Source-url: https://github.com/tesseract-ocr/tesseract/archive/refs/tags/v%version.tar.gz

# For compatibility with third party language packs, configure the location of the tessdata folder inside tesseract
Patch: tesseract_datadir.patch
...
Файлы данных, необходимые для распознавания английского языка OCR.
